...
/**
 * Abstract representation for a BIN file contained in a POD file.
 * @author Stefan Teitge
 */
public interface IBinPodFileEntry extends IPodFileEntry {

	IBinData getData() throws FileLoadException;
}
