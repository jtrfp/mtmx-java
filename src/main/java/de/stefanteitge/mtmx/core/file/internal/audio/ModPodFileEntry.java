 ...
 */
package de.stefanteitge.mtmx.core.file.internal.audio;
...
public class ModPodFileEntry extends PodFileEntry implements IModPodFileEntry {

	public ModPodFileEntry(PodFile podFile) {
		super(podFile);
	}
