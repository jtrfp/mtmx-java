 ...
 */
package de.stefanteitge.mtmx.core.file.internal.image;
...
public class TifPodFileEntry extends PodFileEntry implements ITifPodFileEntry {

	public TifPodFileEntry(PodFile podFile) {
		super(podFile);
	}
